...
if __name__ == '__main__':
    ...
    hybrid_manager.full_flow(s3=True, s3_full=False, delete_files=True, sync_files=True, modify_existing_bucket=False, delete_existing_bucket=False,
                             ec2=False, ec2_full=False, force_ssh=True, installs=False, clone_git=True, start_service=True, setup_iam=False,
                             rds=False, rds_full=True, transfer_data=False, data_transfer_config=data_transfer_config_,
